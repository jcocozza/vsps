...
var genPassword = &cobra.Command{
    ...
    Run: func(cmd *cobra.Command, args []string) {
        password, err := internal.GeneratePassword(passwordLengthFlag, !excludeSpecialCharsFlag, !excludeDigitsFlag, !excludeCapsFlag) 
        if err != nil {
...
func init() {
	...
	genPassword.Flags().BoolVarP(&excludeSpecialCharsFlag, "exclude-special-chars", "s", false, "exclude special characters from autogenerated password")
