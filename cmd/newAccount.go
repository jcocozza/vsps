...
var includeExtraSpecialChars bool
var addExtra bool
...
var newAccount = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if customPassword {
			...
			var err error
			passwordInput, err = internal.GeneratePassword(passwordLength, !excludeSpecialChars, !excludeDigits, !excludeCaps, includeExtraSpecialChars)
			if err != nil {
				fmt.Println(err.Error())
				return
			}
...
func init() {
	...
	newAccount.Flags().BoolVarP(&excludeSpecialChars, "exclude-special-chars", "s", false, "exclude special characters from auto-generated password")
	newAccount.Flags().BoolVarP(&includeExtraSpecialChars, "include-extra-special-chars", "x", false, "include extra special characters like {} in the auto-generated password")
